...
import { Building, Plus, Star, Users, TrendingUp, Settings, ExternalLink } from 'lucide-react'
            ...
            <Card key={business.id} className="hover:shadow-md transition-shadow">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-sm font-medium">{business.trustScore}</span>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="font-medium">{business.monthlyViews.toLocaleString()}</div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">
              {(businesses.reduce((sum, b) => sum + b.trustScore, 0) / businesses.length).toFixed(1)}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">
              {businesses.reduce((sum, b) => sum + b.monthlyViews, 0).toLocaleString()}
            </p>
          </CardContent>
        </Card>
      </div>
